// Only need to think about convesrion in decimal conversion we divide by 10 heere divide by 26 because the no repaets after 26 likwise in ddecimal system 10 base system that is
class Solution {
public:
